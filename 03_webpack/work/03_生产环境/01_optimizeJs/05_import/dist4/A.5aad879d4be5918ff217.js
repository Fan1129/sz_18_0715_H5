...
if(flag === "Ason1"){
    __webpack_require__.e/* import() */("ason1").then(__webpack_require__.bind(null, "./src/A-SON-1.js")).then((str) => {
        console.log(str)
    });
}else {
    __webpack_require__.e/* import() */("ason2").then(__webpack_require__.bind(null, "./src/A-SON-2.js")).then((str) => {
        console.log(str)
    });
}
